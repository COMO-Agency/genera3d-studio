...
BEGIN
  ...
  -- Look up design in org_designs first
  ...
  -- Fallback: look up in free designs catalog
  ...
  -- Color code logic: Standard = first 4 chars, Custom = CMYKW recipe
