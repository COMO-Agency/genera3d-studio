...
-- 1. Neue Hersteller-Spalten in designs
ALTER TABLE public.designs
  ADD COLUMN IF NOT EXISTS manufacturer_name text,
  ADD COLUMN IF NOT EXISTS manufacturer_address text,
  ADD COLUMN IF NOT EXISTS manufacturer_city text,
  ADD COLUMN IF NOT EXISTS manufacturer_atu text,
  ADD COLUMN IF NOT EXISTS manufacturer_contact text;

-- 2. RPC start_production: neues Seriennummer-Format + NULL-Design erlauben
...
begin
  ...
  -- Daily counter for this org + mode
