...
describe("useFormValidation", () => {
  ...
  describe("validation", () => {
    it("should validate required fields", () => {
      ...
      expect(result.current.formState.email?.error).toBe(
    ...
    it("should validate min length", () => {
      ...
      expect(result.current.formState.password?.error).toBe(
...
describe("validators", () => {
  ...
  describe("gs1Format", () => {
    it("should validate GS1 format", () => {
      ...
      expect(
        gs1Validator.pattern?.test("(01)12345678901234(11)250101(21)ABC123"),
      ).toBe(true);
