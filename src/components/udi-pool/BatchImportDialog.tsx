...
const BatchImportDialog = ({ open, onOpenChange, designs, onSubmit, isPending }: BatchImportDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Mehrere UDI-DI-Werte auf einmal anlegen (eine pro Zeile).</DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea rows={6} value={values} onChange={(e) => setValues(e.target.value)} placeholder={"04260001\n04260002\n04260003"} />
          </div>
          <div className="space-y-2">
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={isPending || !designId || !values.trim() || !price}>
